...
/***/ (function(module, exports, __webpack_require__) {
	...
	var OpenStreetMap = (function (_Map) {
	    _inherits(OpenStreetMap, _Map);
	    ...
	    function OpenStreetMap() {
	        ...
	        _get(Object.getPrototypeOf(OpenStreetMap.prototype), "constructor", this).apply(this, args);
	    ...
	    _createClass(OpenStreetMap, [{
	        ...
	        value: function load(callback) {
	            if (window.ol) {
	                ...
	                domUtils.addResources(this.domElement, [domUtils.createStyle("//openlayers.org/en/v4.6.5/css/ol.css"), domUtils.createScript("//cdn.polyfill.io/v2/polyfill.min.js?features=requestAnimationFrame,Element.prototype.classList,URL"), domUtils.createScript("//openlayers.org/en/v4.6.5/build/ol.js")], function () {
	                    callback();
	                });
	            }
	        }
	        ...
	        value: function setCenter(lat, lng) {
	            if (this.map) {
	                ...
	                this.view.centerOn(ol.proj.fromLonLat([lng, lat]), size, [size[0] / 2, size[1] / 2]);
	            }
	        }
	    }, {
	        key: "setIconOnMarker",
	        value: function setIconOnMarker(markerId, icon) {
	            var zIndex = arguments.length <= 2 || arguments[2] === undefined ? 1 : arguments[2];
	        ...
	        value: function focusOnMarker(markerId) {
	            ...
	            if (marker.length) {
	                var coords = ol.proj.transform(marker[0].getGeometry().getCoordinates(), "EPSG:3857", "EPSG:4326");
	        ...
	        value: function addMarkers(points) {
	            ...
	            for (var i = 0; i < points.length; i++) {
	                var iconFeature = new ol.Feature({
	                    type: "icon",
	                    geometry: new ol.geom.Point(ol.proj.fromLonLat([points[i].longitude, points[i].latitude]))
	                });

	                iconFeature.setStyle(this.getStyle(_.get(points[i], "options.icon.url", this.options.marker.icon.url)));
